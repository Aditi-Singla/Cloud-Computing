function UserObject()
{
	...
	this.Render = function()
	{
		...
		for (var i = 0; i < this.UserData.posts.length; i++) {
			var p = this.UserData.posts[i];
			if (p.text == ""){
				var str = "<tc><img src = '"+p.file+"'></tc>";
				totalStr +=  str;
			}
		}
		Object.UnorderedList = "<tl class='images'>" + totalStr + "</tl>";
		...
		if (Object.isEditable){
			...
			$( "#PostTextInput" ).css( {"position":"absolute","top":"30%","left":"30%", "width":"40%" , "height":"7%", "font-size":"1em", "font-weight": "none","color":"#000000","background-color":"rgb(258,258,255)","border":"0px solid rgb(88,151,19)","border-radius":"10px","padding":"0px", "padding-left":"10px", "padding-right":"0px", "box-shadow":"0px 0px 15px #888888"});
			
			Object.PostButton = "<input type='button' id='PostButton' value='Post' />";
			$( "#User_Div"+Object.Index+"" ).append(Object.PostButton);
			$( "#PostButton" ).css( {"position":"absolute","top":"30%","left":"75%", "width":"20%" , "height":"7%", "font-size":"1.2em", "font-weight": "semibold","color":"#FFFFFF","background-color":"#800080","border":"0px solid rgb(88,151,19)","border-radius":"10px","padding":"0px", "padding-left":"0px", "padding-right":"0px", "box-shadow":"2px 2px 5px #888888", "text-align":"center"});	
			...
			$( "#UploadTextInput" ).css( {"position":"absolute","top":"65%","left":"30%", "width":"40%" , "height":"7%", "font-size":"1em", "font-weight": "none","color":"#000000","background-color":"rgb(258,258,255)","border":"0px solid rgb(88,151,19)","border-radius":"10px","padding":"0px", "padding-left":"10px", "padding-right":"0px", "box-shadow":"0px 0px 15px #888888"});
			
			Object.UploadButton = "<input type='button' id='UploadButton' value='Upload' />";
			$( "#User_Div"+Object.Index+"" ).append(Object.UploadButton);
			$( "#UploadButton" ).css( {"position":"absolute","top":"65%","left":"75%", "width":"20%" , "height":"7%", "font-size":"1.2em", "font-weight": "semibold","color":"#FFFFFF","background-color":"#800080","border":"0px solid rgb(88,151,19)","border-radius":"10px","padding":"0px", "padding-left":"0px", "padding-right":"0px", "box-shadow":"2px 2px 5px #888888", "text-align":"center"});	
